...
const touristPlaces = [
  {
    ...
    desc: "Trek to the world's 3rd highest peak base camp through pristine alpine wilderness.",
    difficulty: "Extreme",
    duration: "12-15 days",
    bestTime: "May–Oct",
    icon: "🏔️",
  ...
  },
  {
    ...
    desc: "One of the world's highest lakes at 17,800 ft, sacred to both Buddhists and Hindus.",
    difficulty: "Moderate",
    duration: "2-3 days",
    bestTime: "May–Oct",
    icon: "💧",
  ...
  },
  {
    ...
    desc: "The Valley of Flowers — stunning rhododendron blooms at 11,800 ft every spring.",
    difficulty: "Easy",
    duration: "1-2 days",
    bestTime: "Apr–Jun",
    icon: "🌸",
  ...
  },
  {
    ...
    desc: "Historic Silk Route mountain pass at 14,140 ft on the India-China border.",
    difficulty: "Moderate",
    duration: "1 day",
    bestTime: "May–Oct",
    icon: "🏔️",
  ...
  },
  {
    ...
    desc: "Sacred glacial lake at 12,310 ft, shimmering turquoise surrounded by steep slopes.",
    difficulty: "Easy",
    duration: "1 day",
    bestTime: "Mar–Dec",
    icon: "❄️",
  ...
  },
  {
    ...
    desc: "Ancient Silk Route village with 32 hairpin bends and panoramic Himalayan views.",
    difficulty: "Moderate",
    duration: "2-3 days",
    bestTime: "Oct–May",
    icon: "🛤️",
  ...
  },
  {
    ...
    name: "Pelling",
    type: "Town",
    coordinates: [27.2985, 88.1182],
    desc: "Panoramic views of Kanchenjunga from Pelling town with nearby monasteries.",
    difficulty: "Easy",
    duration: "2 days",
    bestTime: "Oct–May",
    icon: "🏘️",
  ...
  },
  {
    ...
    type: "Monastery",
    coordinates: [27.3012, 88.6177],
    desc: "One of the largest Buddhist monasteries in Sikkim, vibrant center of Karma Kagyu.",
    difficulty: "Easy",
    duration: "Half day",
    bestTime: "All year",
    icon: "🛕",
  ...
  },
  {
    ...
    type: "Adventure",
    coordinates: [27.1667, 88.5167],
    desc: "Thrilling Grade III–IV white water rafting through stunning Himalayan gorges.",
    difficulty: "Hard",
    duration: "Half day",
    bestTime: "Oct–Apr",
    icon: "🚣",
  ...
  },
  {
    ...
    name: "Ravangla",
    type: "Town",
    coordinates: [27.3055, 88.3625],
    desc: "Home to the 130 ft Buddha Park statue with panoramic south Sikkim views.",
    difficulty: "Easy",
    duration: "1 day",
    bestTime: "All year",
    icon: "🧘",
  ...
  },
  {
    ...
    name: "Lachen",
    type: "Village",
    coordinates: [27.7267, 88.5617],
    desc: "Gateway village to Gurudongmar Lake — traditional Lepcha settlement at 8,700 ft.",
    difficulty: "Easy",
    duration: "1 day",
    bestTime: "May–Oct",
    icon: "🏡",
  ...
  },
  {
    ...
    type: "Park",
    coordinates: [27.6106, 88.1494],
    desc: "UNESCO World Heritage Site — diverse wildlife, glaciers, sacred sites.",
    difficulty: "Hard",
    duration: "3-5 days",
    bestTime: "May–Nov",
    icon: "🌿",
...
const bikeVendors = [
  {
    id: 1,
    name: "Himalayan Riders Sikkim",
    location: "MG Marg, Gangtok",
    phone: "+91 98320 11234",
    rating: 4.8,
    reviews: 142,
    bikes: ["RE Himalayan 411", "RE Classic 350", "Honda Activa"],
    priceFrom: 800,
    open: "8am–7pm",
    verified: true,
    img: "🏍️",
  ...
  {
    id: 2,
    name: "Sikkim Adventure Wheels",
    location: "Tadong, Gangtok",
    phone: "+91 97334 56789",
    rating: 4.6,
    reviews: 98,
    bikes: ["RE Thunderbird 350", "Bajaj Dominar 250", "Honda CB Shine"],
    priceFrom: 700,
    open: "7am–8pm",
    verified: true,
    img: "🛵",
  },
  {
    ...
    phone: "+91 89721 33445",
    rating: 4.7,
    reviews: 211,
    bikes: ["RE Himalayan", "Trek MTB", "Hero Splendor+"],
    priceFrom: 400,
    open: "8am–6pm",
    verified: true,
    img: "🚵",
  ...
  {
    id: 4,
    name: "Northeast Bike Hub",
    location: "Pelling, West Sikkim",
    phone: "+91 70449 88120",
    rating: 4.5,
    reviews: 67,
    bikes: ["RE Classic 350", "RE Electra", "Honda Activa 6G"],
    priceFrom: 600,
    open: "9am–6pm",
    verified: false,
    img: "🏍️",
  ...
  {
    id: 5,
    name: "Kanchenjunga Bike Rentals",
    location: "National Highway, Siliguri",
    phone: "+91 93320 77654",
    rating: 4.4,
    reviews: 184,
    bikes: ["RE Bullet 350", "Bajaj Pulsar 150", "Hero Passion"],
    priceFrom: 500,
    open: "7am–9pm",
    verified: true,
    img: "🛵",
  ...
  {
    id: 6,
    name: "Sikkim MTB & Trail Co.",
    location: "Ravangla, South Sikkim",
    phone: "+91 85920 44321",
    rating: 4.9,
    reviews: 55,
    bikes: ["Trek Marlin 7 MTB", "Giant Talon MTB", "Cannondale Trail"],
    priceFrom: 450,
    open: "8am–5pm",
    verified: true,
    img: "🚵",
  ...
  {
    id: 7,
    name: "Gangtok Scooter Point",
    location: "31A, Gangtok",
    phone: "+91 97480 22134",
    rating: 4.3,
    reviews: 299,
    bikes: ["Honda Activa 6G", "TVS Jupiter", "Suzuki Access"],
    priceFrom: 350,
    open: "8am–8pm",
    verified: false,
    img: "🛵",
  ...
  {
    id: 8,
    name: "Summit Riders Lachung",
    location: "Lachung Village",
    phone: "+91 96419 88765",
    rating: 4.7,
    reviews: 43,
    bikes: ["RE Himalayan 411", "Hero Xpulse 200"],
    priceFrom: 1200,
    open: "7am–6pm",
    verified: true,
    img: "🏍️",
...
const Adventure = () => {
  ...
  useEffect(() => {
    ...
    fetch(
      `${import.meta.env.VITE_API_BASE_URL || "http://localhost:5000"}/bikes`,
    )
      .then((r) => r.json())
  ...
  const filteredVendors =
    vendorFilter === "All"
      ? displayBikes
      : displayBikes.filter((v) =>
          (v.location || "").toLowerCase().includes(vendorFilter.toLowerCase()),
        );
  const filteredAdv =
    activeFilter === "All"
      ? adventures
      : adventures.filter((a) => a.cat === activeFilter);
    ...
    <div className={styles.root}>
        ...
        <div className={styles.hero}>
          ...
          <div className={styles.heroImgCol}>
            <div
              ...
              style={{
                backgroundImage:
                  "url('https://leavetheroad.in/wp-content/uploads/2025/08/20240729_113011.jpg')",
              }}
            >
          ...
          <div className={styles.heroContent}>
            ...
            <p className={styles.heroSubtitle}>
              Journey beyond the ordinary — discover Sikkim's mountains,
              valleys, and hidden wonders.
            </p>
                ...
                <div className={styles.heroDecorPills}>
                  {[
                    ...
                    <span key={p.label} className={styles.heroDecorPill}>
                      <span
                        className={styles.heroDecorPillDot}
      ...
      <div className={styles.marqueeStrip}>
        <div className={styles.marqueeTrack}>
          ...
          {[
            ...
            <span key={s + "2"} className={styles.marqueeItem} aria-hidden>
              <span className={styles.marqueeDot}>✦</span>
              {s}
            </span>
          ))}
      ...
      <section className={styles.sec}>
        ...
        <div className={styles.destinationGrid}>
          {touristPlaces.slice(0, 6).map((pl, i) => (
            <div
              key={pl.id}
              className={`${styles.destCard} ${i === 0 ? styles.destCardFeatured : ""}`}
              onClick={() => openLocation(pl)}
            >
              <div
                ...
                style={{
                  ...
                  }?w=400&q=60&auto=format&fit=crop')`,
                }}
              >
                <div className={styles.destImgOver} />
                <span
                  className={styles.destTag}
        ...
        <div className={styles.viewAllWrap}>
          <button
            ...
            onClick={() => setShowMapModal(true)}
          >
            View All {touristPlaces.length} Destinations on Map{" "}
            <ArrowRight size={15} />
          </button>
        </div>
      </section>
      ...
      <div className={styles.tagline}>
        <h2>
          ...
          <span
            className={styles.taglineImgInline}
            style={{
              backgroundImage:
                "url('https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=400&q=60&auto=format&fit=crop')",
            }}
          />{" "}
          the world{" "}
          <span
            ...
            style={{
              backgroundImage:
                "url('https://images.unsplash.com/photo-1464822759023-fed622ff2c3b?w=400&q=60&auto=format&fit=crop')",
            }}
          />{" "}
          waiting for you.
        </h2>
        <p>
          Travelling changes you. You see new places, meet new people, and
          ...
          <div className={styles.secHead}>
            ...
            <div className={styles.filterPills}>
              {["All", "Biking", "Water", "Trek", "Sky", "Camp"].map((f) => (
                <button
                  key={f}
                  className={`${styles.fPill} ${activeFilter === f ? styles.fPillOn : ""}`}
          ...
          <div className={styles.advGrid}>
            {filteredAdv.map((a) => (
              <div
                ...
                style={{ "--ac": a.col }}
                onClick={() =>
                  a.cat === "Biking" ? setShowVendors(true) : null
                }
              >
                <div
                  className={styles.advCardTop}
                ...
                <div className={styles.advCardBody}>
                  <div className={styles.advCardMeta}>
                    <span
                      className={styles.advCount}
                      style={{ color: a.col, background: `${a.col}15` }}
                    >
                      {a.count}
                    </span>
                  </div>
        ...
        <div className={styles.whyGrid}>
          <div className={styles.whyLeft}>
            ...
            <h2 className={styles.secH2}>
              to new places, people
              <br />& experiences.
            </h2>
            <p className={styles.whyP}>
              Sikkim offers an unmatched combination of Himalayan peaks, crystal
              lakes, ancient monasteries, and warm local culture — all in one
              compact, breathtaking state.
            </p>
            <div className={styles.whyFeatures}>
              {[
                "UNESCO World Heritage Sites",
                "Over 30 trekking routes",
          ...
          <div className={styles.whyRight}>
            <div className={styles.whyImgGrid}>
              ...
              />
              <div
                className={styles.whyImg3}
                style={{
                  backgroundImage:
                    "url('https://images.unsplash.com/photo-1537225228614-56cc3556d7ed?w=400&q=60&auto=format&fit=crop')",
                }}
              />
              <div className={styles.whyBadge}>
                <span className={styles.whyBadgeNum}>4.9</span>
                <Star size={18} fill="#f59e0b" color="#f59e0b" />
                <span className={styles.whyBadgeLbl}>
      ...
      <section className={styles.bikeCTA}>
        <div className={styles.bikeCTAInner}>
          <div className={styles.bikeCTALeft}>
            ...
            <p>
              From Royal Enfield Himalayans to mountain bikes — we have the
              right wheels for every road.
            </p>
            <div className={styles.bikeCTABtns}>
              <button
                className={styles.bikeCTAMain}
                onClick={() => setShowVendors(true)}
              >
                View All Bike Vendors
              </button>
              <button
                className={styles.bikeCTASecondary}
                onClick={() => setShowMapModal(true)}
              >
          ...
          <div className={styles.bikeCTARight}>
            <div className={styles.bikePreview}>
              <div
                className={styles.bikePreviewImg}
                style={{
                  backgroundImage:
                    "url('https://images.unsplash.com/photo-1558981852-426c349548ab?w=400&q=60&auto=format&fit=crop')",
                }}
              />
      ...
      {showVendors && (
        <div
          ...
          onClick={(e) => e.target === e.currentTarget && setShowVendors(false)}
        >
          <div className={styles.vendorModal}>
            <div className={styles.vendorModalHead}>
              <div>
                ...
                <p>
                  {bikesLoading
                    ? "Loading..."
                    : `${filteredVendors.length} vendor(s) available across Sikkim`}
                </p>
              </div>
              <button
            ...
            <div className={styles.vendorFilters}>
              <span className={styles.vendorFilterLbl}>
                <Filter size={13} /> Filter by location:
              </span>
              {[
                "All",
                "Gangtok",
                ...
                <button
                  key={loc}
                  className={`${styles.vFChip} ${vendorFilter === loc ? styles.vFOn : ""}`}
                  onClick={() => setVendorFilter(loc)}
                >
                  {loc}
                </button>
              ))}
                  ...
                  >
                        ...
                        <img
                          src={
                            v.images[0].startsWith("http")
                              ? v.images[0]
                              : `${import.meta.env.VITE_API_BASE_URL || "http://localhost:5000"}${v.images[0]}`
                          }
                          alt={v.name}
                    ...
                    <div className={styles.vendorBody}>
                      ...
                      <div className={styles.vendorMeta}>
                        ...
                        {v.open && (
                          <span>
                            <Clock size={12} /> {v.open}
                          </span>
                        )}
                        <span>
                          <Phone size={12} /> {v.phone || v.contactNumber}
                        </span>
                      </div>
                      <div className={styles.vendorBikes}>
                        {(v.bikes || (v.name ? [v.name] : [])).map((b) => (
                          <span key={b} className={styles.vBikeChip}>
                            {b}
                          </span>
                        ))}
                      </div>
                    ...
                    <div className={styles.vendorRight}>
                      ...
                      <div className={styles.vendorPrice}>
                        ...
                        <span className={styles.vendorPriceNum}>
                          ₹{v.priceFrom || v.dailyRate}
                        </span>
      ...
      {showMapModal && (
        <div
          className={styles.modalBack}
          onClick={(e) =>
            e.target === e.currentTarget && setShowMapModal(false)
          }
        >
          <div className={styles.mapModal}>
            <div className={styles.mapModalHead}>
              <div>
                ...
                <p>
                  {touristPlaces.length} places to visit — click any pin for
                  details
                </p>
              </div>
              <button
            ...
            <div className={styles.mapModalBody}>
              ...
              <div className={styles.mapSidebar}>
                ...
                {touristPlaces.map((pl) => (
                  <div
                    key={pl.id}
                    className={styles.mapSideItem}
                    onClick={() => openLocation(pl)}
                  >
                    <span
                      className={styles.mapSideDot}
                      style={{ background: pl.color }}
                    />
                    <div className={styles.mapSideText}>
                      <strong>{pl.name}</strong>
                      <span>
                        {pl.type} · {pl.difficulty}
                      </span>
                    </div>
              ...
              <div className={styles.mapFrame}>
                ...
                >
                  ...
                  {touristPlaces.map((pl) => (
                    <Marker
                      key={pl.id}
                      position={pl.coordinates}
                      icon={makeIcon(pl.color, pl.icon)}
                      eventHandlers={{ click: () => openLocation(pl) }}
                    >
                      <Popup>
                        <div className={styles.mapPopup}>
                          <div
                            className={styles.mapPopupBar}
                            style={{ background: pl.color }}
                          />
                          ...
                          <div className={styles.mapPopupRow}>
                            <span
                              className={styles.mapDiff}
                              style={{
                                background: `${diffColors[pl.difficulty]}18`,
                                color: diffColors[pl.difficulty],
                              }}
                            >
                              {pl.difficulty}
                            </span>
